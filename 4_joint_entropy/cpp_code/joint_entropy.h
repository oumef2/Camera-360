...
void joint_entropy(int_fixed imgl[ox*oy],int_fixed imgr[ox*oy],double_fixed entropy[ox*oy]);
void distribution_probability2(int_fixed imgl[ox*oy],int_fixed imgr[ox*oy], long_fixed dst[max_pixels]);
double_fixed mylog2(long_fixed m);
